...
public int UpdateFile(){
    ...
    File file=new File("C:/Project File/CourseDetailsInformation.txt");
    File temporaryfile=new File("C:/Project File/CourseDetailsInformation1.txt");
...
printWriter.close();
            ...
            File file3=new File("C:/Project File/CourseDetailsInformation.txt");
